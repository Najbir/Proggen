 ...
 * Da Wir in Gruppen Arbeiten, hat jeder eine genaue Aufgabe
 * Anil -> Server für das Online Spielen.
 * Kim -> Mechanik um die Zeichen zu initialiesieren.
 * Najbir -> GUI+Main für das Visualiesiern des Spiel feldes.
 * Da wir zusammen gearbeitet haben, hat jede sein Teil seperat abgeschickt, um zu zeigen, welchen part er/sie
 * hatte.
 * Deshalb, kommt es zu einem Compiler Fehler in dieser Main.
 * 
 * In der FINAL Version, haben wir alles in einem!
 */
