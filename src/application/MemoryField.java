...
public class MemoryField {
	//10 Zeichen im spiel werden die 2 mal vorkommen!
	private final int cardsLength=10;
	//zeichen werden im charArray implementiert
	private final char[][] charArray=new char[4][5]; 
	//Belegung der zeichen im Array prüfen
	private final boolean[][] boolArray=new boolean[4][5];
	//Zeichen in kleinen Buchstaben
	...
	/**
	 * gibt das Array der kleinen Buchstaben wieder
	 * @return charArray = befuellte chars in dem Array
	 */
	...
	private void Matchfield(){
		...
		int index=0; //Lauf Index fuer randomString 
		while(!allTrue()){//Solang alle Werte nicht belegt sind, mache folgendes:
			...
			if(!boolArray[rand1][rand2] ){
				...
				//Belegung auf True setzen an der gleichen stelle wie rand1 und rand2
